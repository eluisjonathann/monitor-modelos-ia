...
> 🔄 **Última sincronización automática:** `2026-09-11 07:55 UTC`
...
| 3 | **Claude Opus 5 (max)** | 50.7 | 52.0 t/s | $5.8584 | 1000k |
| 4 | **Claude Fable 5 (with fallback)** | 49.7 | 65.1 t/s | - | 1000k |
| 5 | **Muse Spark 1.3 (max)** | 48.17 | 201.4 t/s | $1.6049 | 1000k |
| 6 | **GPT-5.6 Sol (max)** | 47.06 | 59.6 t/s | - | 1000k |
...
| 10 | **GPT-5.6 Terra (max)** | 42.25 | 84.0 t/s | - | 1000k |
